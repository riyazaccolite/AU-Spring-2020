var myModule = (function(){
    ...
    function _User(firstName, lastName, age){ // PRIVATE
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
    }

    function _print(){ // PRIVATE
        for(let key in this)
            console.log(key + ": " + this[key]);
        console.log();
    }
    
    function _changeUser(firstName, lastName, age){ // PRIVATE
        this.firstName = firstName;
        this.lastName = lastName;
        this.age = age;
    }
    ...
    function addField(field,value){ // BINDED BELOW
        this[field] = value;
    }
...
let myUpdater = myModule.addField.bind(user1); // BIND
